...
const CreateListingPage = ({ _userLoggedIn }) => {
    ...
    const onImgDelete = async (imgURL) => {
        try {
            ...
            setImageURLs(
                imageURLs.filter((imgObj) => imgObj.publicURL !== imgURL)
            );
        } catch (error) {
            alert(error.message);
        } finally {
...
const CreateListingBody = (props) => {
    ...
    return submitting ? (
        ...
        >
            ...
            />
            <p className="text-danger mt-1 mb-5">
          ...
          placeholder ListingImage for user to add new images */}
            ...
            <div className={createListingPageStyles["listing-fields"]}>
                ...
                <div className="d-flex flex-row align-items-center mb-1">
                    <h1 className="nunito-medium-black-24px mx-2 my-0 p-0">
                        to teach
                    </h1>
                    <input
                        id="subject"
          ...
          Required field, with a maximum of 100 characters. */}
                ...
                >
                    <input
                        className={
                            createListingPageStyles["describe-listing-text"]
                        }
...
const SelectionField = (props) => {
    ...
    return (
      ...
      */}
            <select
                className={
                    createListingPageStyles["selection-dropdown-box-master"]
                }
